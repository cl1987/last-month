        ...
        return (
            <Layout>
                 <Breadcrumb style={{ margin: '16px 0' }}>
                  ...
                  <Breadcrumb.Item>
                    添加商品{this.state.productId ? "修改商品" : "添加商品"}
                  </Breadcrumb.Item>
                </Breadcrumb>
                <div className="content">
                    <Form labelCol={{ span: 5 }} wrapperCol={{ span: 12 }} >
                        ...
                        <Form.Item 
                          label="封面图片"
                          required={true}
                          validdateStatus={mainImageValidateStatus}
                        ...
                        <Form.Item 
                          label="商品图片"
                          required={true}
                          validdateStatus={imagesValidateStatus}
                          help={imagesHelp}
                        >
                            <UploadImage
                                max={3}
...
const WrappedProductSave = Form.create({ name: 'category' })(ProductSave)
//映射属性到组件
